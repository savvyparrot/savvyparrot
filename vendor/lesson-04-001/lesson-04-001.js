...
(lib.FarmhouseBitmap = function() { this.initialize(img['img-farmhouse']); }).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1500,1201);


(lib.IslandBitmap = function() { this.initialize(img['img-island']); }).prototype = p = new cjs.Bitmap();
