...
(function (targetNS) {
  targetNS.Pepi = function () {
    this.initialize();
    var shape = null;
    shape = new createjs.Shape();
    shape.graphics.f('#363953').s().p('AAABoQgDhogBhnIAIAAIAADFIAAAKg');
    shape.setTransform(192.5, 590.8);
    this.addChild(shape);
    shape = new createjs.Shape();
    shape.graphics.f('#545A80').s().p('AgFA7IAAh/IAIAAIABAJQAHBMgQA0IAAgKg');
    ...
    shape = new createjs.Shape();
    shape.graphics.f('#24212D').s().p('AAAAzQgKgOACgbQALhUADASQAIA8gOA4QAAgFAAgEg');
    shape.setTransform(225.9, 475.3);
    this.addChild(shape);
    shape = new createjs.Shape();
    shape.graphics.f('#646A99').s().p('');
  ...
  targetNS.Pepi.prototype = new createjs.Container();
  targetNS.Pepi.prototype.nominalBounds = new createjs.Rectangle(0, 0, 449, 662.3);
}(SavvyParrot));
var lib = lib || {};
(function (lib, cjs) {
  var p;
  (lib.WelcomeMovieClip = function (mode, startPosition, loop) {
    ...
    var TIME_PEPI_ENTRANCE = 16;
    var TIME_WELCOME = TIME_PEPI_ENTRANCE + 31;
