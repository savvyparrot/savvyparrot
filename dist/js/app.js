...
(function (lib, img, cjs) {
  ...
  (lib.PepiMovieClip = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({
      ...
      y: 630.6,
      alpha: 0.327
    }, 0).wait(1).to({ alpha: 0.306 }, 0).wait(1).to({ alpha: 0.286 }, 0).wait(1).to({ alpha: 0.265 }, 0).wait(1).to({ alpha: 0.245 }, 0).wait(1).to({ alpha: 0.224 }, 0).wait(1).to({ alpha: 0.204 }, 0).wait(1).to({ alpha: 0.184 }, 0).wait(1).to({ alpha: 0.163 }, 0).wait(1).to({ alpha: 0.143 }, 0).wait(1).to({ alpha: 0.122 }, 0).wait(1).to({ alpha: 0.102 }, 0).wait(1).to({ alpha: 0.082 }, 0).wait(1).to({ alpha: 0.061 }, 0).wait(1).to({ alpha: 0.041 }, 0).wait(1).to({ alpha: 0.02 }, 0).wait(1).to({ alpha: 0 }, 0).to({ _off: true }, 1).wait(110));
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(0, 0, 1024, 768);
  (lib.FarmhouseBitmap = function () {
    this.initialize(img['img-farmhouse']);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 1500, 1201);
  (lib.IslandBitmap = function () {
    this.initialize(img['img-island']);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 1523, 1219);
  (lib.IslandContainer = function () {
    this.initialize();
    var bmpIsland = new lib.IslandBitmap();
  ...
  (lib.FarmContainer = function () {
    this.initialize();
    this.instance = new lib.FarmhouseBitmap();
  ...
  (lib.Island_Symbol = function () {
    this.initialize();
    this.instance = new lib.IslandContainer();
  ...
  (lib.FarmMovieClip = function (mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {});
    var farm0 = new lib.FarmContainer('synched', 0);
    farm0.setTransform(97, 20.1);
    farm0.alpha = 1;
    var farm1 = new lib.FarmContainer('synched', 0);
